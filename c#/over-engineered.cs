...
class Program {
  async static Task Main(string[] args) {
    ...
    string helloWorldString =
        await helloWorldController.GetHelloWorldStringAsync();
...
/// <summary>
/// This class can retrieve the desired "Hello World!" value asynchronously by
/// creating a new Thread via the Task.Run Method.
/// </summary>
